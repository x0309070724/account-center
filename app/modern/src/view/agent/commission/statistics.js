Ext.define('APP.view.agent.commission.statistics', {
  extend: 'Ext.List',
  xtype: 'agentCommissionStatistics',
  controller: 'agent.commission',
  viewModel: {data: {parameter: {_field: 'type'}}},
  store: {
  ...
  items: [
    ...
    {xtype: 'boxdatepart'},
    {
      ...
      items: [
        {text: '交易类型', iconCls: 'f-mt mt-user-3', value: 'type'},
        {text: '佣金', iconCls: 'f-mt mt-user-3', value: 'commission'}
      ]
    }
  ],
  userCls: 'x-ui-list',
