Ext.define('APP.view.depowith.deposit.deposit', {
  extend: 'Ext.List',
  controller: 'depowith',
  grouped: true,
  store: {
  ...
  itemTpl:[
    ...
    '<div class="x-ui-explain">',
      '<p class="x-ui-first">',
        ...
        '<span class="x-ui-label x-ui-bg-green">{groupname}</span>',
      '</p>',
      '<p><label>入金金额：</label><span class="x-ui-box-label x-ui-text-red">{amount_usd:usMoney}</span></p>',
      '<p><label>实付金额：</label><span class="x-ui-box-label x-ui-text-green">{amount:usMoney}</span></p>',
